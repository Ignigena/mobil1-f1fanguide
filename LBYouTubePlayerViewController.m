...
-(void)loadYouTubeVideoFromURL:(NSURL *)URL
{
    [self _setupWithYouTubeURL:URL];
}
    ...
    if (JSONStart != nil) {
        ...
        if (decodingError) {
            ...
            *error = decodingError;
            ...
            _youTubeVideoID = [[[JSONCode objectForKey:@"content"] objectForKey:@"video"] objectForKey:@"encrypted_id"];
...
-(void)_loadVideoWithContentOfURL:(NSURL *)videoURL {
    [self.view loadYouTubeVideo:videoURL withID:_youTubeVideoID];
}
